//
//  PlacePlungerViewController.swift
//  Bloom
//
...
class PlacePlungerViewController: UIViewController {
...
//********************************************************************************
    ...
    @IBOutlet weak var plungerTimerLabel: UILabel!
...
//********************************************************************************
    ...
    @objc func updateTimer() {
        ...
        if seconds < 1 {
            ...
            seconds -= 1
            // Update the label
            plungerTimerLabel.text = timeString(time: TimeInterval(seconds))
        }
    }
